/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.jsonc worker/env.d.ts` (hash: f475101f5c57effdd7add35d952d6306)
// Runtime types generated with workerd@1.20260820.1 2026-08-24 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AI: Ai;
	ALLOWED_ORIGINS: "https://kristinzhiyingchen.com,https://www.kristinzhiyingchen.com,http://localhost:3000";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "GLOBAL_DAILY_LIMIT" | "REPORT_TTL_DAYS" | "TURNSTILE_SECRET" | "RATE_LIMIT_SECRET" | "TURNSTILE_HOSTNAMES" | "ENVIRONMENT">> {}
}
